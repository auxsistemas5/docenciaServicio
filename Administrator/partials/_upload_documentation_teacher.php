<div class="container">
    ...
    <div class='card card-danger'>
        <div class='row'>
            <div class='col-lg-12'>
                <form  enctype="multipart/form-data" action="../logica/add_documentation_teacher.php" method="POST">
                    ...
                    <div class='card-body'>
                        <div class="row">
                            ...
                            <div hidden><input type="text" name="id_docente" value="<?php echo $dates[0] ?>" hidden></div>
